...
public class bilgi2Nedir extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bilgi2_nedir);
        getWindow().setStatusBarColor(ContextCompat.getColor(bilgi2Nedir.this,R.color.color1));

        String ilacBilgisi = getIntent().getStringExtra("ilacBilgisi");
        String ilacAdi = getIntent().getStringExtra("ilacAdi");

        txtBaslik = findViewById(R.id.baslikNedir);
        txtBilgi = findViewById(R.id.bilgiNedir);

        txtBaslik.setText(ilacAdi + " Nedir?");
