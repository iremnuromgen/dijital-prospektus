...
public class bilgi6YanEtki extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bilgi6_yan_etki);
        getWindow().setStatusBarColor(ContextCompat.getColor(bilgi6YanEtki.this,R.color.color1));

        String ilacBilgisi = getIntent().getStringExtra("ilacBilgisi");
        String ilacAdi = getIntent().getStringExtra("ilacAdi");

        txtBaslik = findViewById(R.id.baslikYanEtki);
        txtBilgi = findViewById(R.id.bilgiYanEtki);

        txtBaslik.setText(ilacAdi + " Yan Etkileri Neler?");
