...
public class bilgi1Uyari extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bilgi1_uyari);
        getWindow().setStatusBarColor(ContextCompat.getColor(bilgi1Uyari.this,R.color.color1));

        String ilacBilgisi = getIntent().getStringExtra("ilacBilgisi");
        String ilacAdi = getIntent().getStringExtra("ilacAdi");

        txtBaslik = findViewById(R.id.baslikUyari);
        txtBilgi = findViewById(R.id.bilgiUyari);

        txtBaslik.setText(ilacAdi + " Hakkında Uyarı");
